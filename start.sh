...
cat /opt/kafka/config/server.properties.tmpl | sed \
  ...
  -e "s|{{KAFKA_MAX_REQUEST_SIZE}}|${KAFKA_MAX_REQUEST_size:-20971520}|g" \
  -e "s|{{KAFKA_MESSAGE_MAX_BYTES}}|${KAFKA_MESSAGE_MAX_BYTES:-20971520}|g" \
  -e "s|{{KAFKA_MAX_PARTITION_FETCH_BYTES}}|${KAFKA_MAX_PARTITION_FETCH_BYTES:-20971520}|g" \
